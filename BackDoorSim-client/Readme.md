...
You can use all windows shell commands for find, download or upload files, open programs by commands below
   -`start [name_app or link]`: Open application.
   -`dir`: show all files in your path.
   -`cd`: change your path.
